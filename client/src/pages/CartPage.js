      ...
      <div className="cart-page">
        ...
        <div className="container">
          <div className="row main1">
            <div className="col-md-7 p-0 m-0 all-cards">
              {cart?.map((p) => (
                <div className="row card flex-row bg-transparent" key={p._id}>
            ...
            <div className="col-md-5 cart-summary ">
              ...
              <hr />
              <h4>Total: <span style={{fontSize: "20px"}}>{totalPrice()}</span></h4>
              {auth?.user?.address ? (
                <>
                  <div className="mb-3">
                    <h4>Current Address: <span style={{fontSize: "20px"}}>{auth?.user?.address}</span></h4>
                    <button
